...
exogenous_counts_export <- rbind(
  ...
  exogenous_counts_temp %>%
    group_by(background, mixture, day, replicate, sequence_name) %>%
...
# Color palette
human_gene_colors <- c("#a9a9a9", "#777777")
exogenous_gene_colors <- c("#bc5090", "#ffa600")
na_color <- "#dddddd"
